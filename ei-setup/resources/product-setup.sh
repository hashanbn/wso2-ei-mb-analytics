...
mv -f /tmp/resources/conf/axis2/* /wso2/wso2ei-6.1.1/conf/axis2/
...
mkdir -p /wso2/wso2ei-6.1.1/repository/deployment/server/dataservices

mv -f /tmp/resources/repository/deployment/server/dataservices/* /wso2/wso2ei-6.1.1/repository/deployment/server/dataservices/

mv -f /tmp/resources/conf/synapse.properties /wso2/wso2ei-6.1.1/conf/

mv -f /tmp/resources/lib/* /wso2/wso2ei-6.1.1/lib/
